  ...
  return (
    <Modal
      ...
      <View style={detailStyle.container}>
        ...
        <TouchableOpacity
          style = {{backgroundColor:'#53a0db',alignSelf:'center', paddingHorizontal:20, paddingVertical:10, borderRadius:7, marginVertical:10}}
          onPress = {() => Linking.openURL(props.restaurant.mobile_reserve_url)}
        >
